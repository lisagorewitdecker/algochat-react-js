...
class ccMessageFooter extends Component {
  ...
  render() {
    ...
    return (
      <div>
         <Row id="attachMenuContainer" className="attachMenuContainer" active="false">
           <div className="inline-center">
            <div onClick={this.handleMediaMessageGallery.bind(this)}>
              <input
              ...
              />
                <div className="color-font-theme" dangerouslySetInnerHTML={{ __html: icon_attach_gallery }}></div>
            ...
            <div className="inline-center">
                          <div onClick={this.openModalHandler.bind(this,'camera')}>
                <div className="color-font-theme" dangerouslySetInnerHTML={{ __html: icon_attach_cam }}></div>
...
<div className="inline-center">
              <div onClick={this.handleMediaMessageVideo.bind(this)} >
              <input
                ...
                style={ccMessageInputFile}
                />
                <div className="color-font-theme" dangerouslySetInnerHTML={{ __html: icon_attach_video }}></div>
...
<div className="inline-center">
            <div onClick={this.handleMediaMessageAudio.bind(this)}>
              <input
                ...
                style={ccMessageInputFile}
                />
                <div className="color-font-theme" dangerouslySetInnerHTML={{ __html: icon_attach_mic }}></div>
...
<div className="inline-center">
            <div onClick={this.handleMediaMessageFile.bind(this)}>
              <input
                ...
                <div className="color-font-theme" dangerouslySetInnerHTML={{ __html: icon_attach_file }}></div>
              ...
              {/* <center>
                <div className="attachMenuIcon color-font-theme" dangerouslySetInnerHTML={{ __html: icon_attach_location }}></div>
              {/* </center> */}

              {/* <div className="attachMenuText color-font"> 
                  Location
              </div>  */} 
            {/* </Col> */}
          </div>
