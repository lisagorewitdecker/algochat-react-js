            ...
            <Modal >
                ...
                <div className="callNotificationModal">
                    <div className="CallNotificationHeader" >
                        <span className="CallNotificationUserImageContainer" >
                        
                            <img className="img-circle" src={user_avatar} height="40px" width="40px"/>
                        </span>
                        
                        <div className = "CallNotificationDetailContainer">
                            
                            <div className="CallNotificationUserName">
                                <span>{this.props.user_name}</span>
                            </div>

                            <div className="CallNotificationUserStatus">
                                <span>Incoming Call</span>
                            </div>
                        </div>

                        <div className="btnAcceptCallNotification" dangerouslySetInnerHTML={{__html:icon_call_accept}}
                        onClick={this.acceptCall.bind(this)} />
                             
                        

                        <div className="btnRejectCallNotification" dangerouslySetInnerHTML={{__html:icon_call_reject}}
