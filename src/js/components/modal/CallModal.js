            ...
            return ( 
                <Modal>
                    <div className="modal">
                        ...
                        <div className="callModalFooter">
    
                            {/* <div className="btnAcceptCall" dangerouslySetInnerHTML={{__html:icon_call_accept}}>
                            </div> */}
    
                            <div className="btnRejectCall" dangerouslySetInnerHTML={{__html:icon_call_reject}} onClick={this.cancelCall.bind(this)} />                    
